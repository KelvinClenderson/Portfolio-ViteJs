    ...
    const services = [
        {
            title: "Web",
            description:
                "Desenvolvimento de sites e sistemas web estáticos e dinâmicos com React.js, Vite.js, HTML5 e CSS3.",
        ...
        },
        {
            title: "Mobile",
            description:
                "Desenvolvimento de aplicativos Android e iOS com Ionic Framework",
        ...
        <section className="container mx-auto my-12 max-w-4x1 p-4">
            <div className="p-4 text-center">
                ...
                <h2 className="mb-2 font-bold text-blue-900">
                    <span className="mr-2 font-headline text-3x1">Meus</span>
                    <span className="font-handwriting text-4x1">Serviços</span>
                </h2>
