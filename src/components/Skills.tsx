...
export function Skills() {
    const educations = [
        {
            name: "Engenharia de Software | Wyden",
        },
        {
            name: "Desenvolvimento Mobile com Ionic Framework | Udemy",
        },

        {
            name: "Bootcamp WEX - Desenvolvimento .NET e QA | Digital Innovation One",
        },
    ];
        ...
        <section className="rounded-br-[80px] bg-gray-300 md:rounded-br-[180px]">
            <div className="container mx-auto max-w-4xl p-4 py-12">
                <div className="relative mb-4 p-4 text-center">
                    ...
                    <p className="relative  text-center md:text-left">
                        FullStack Developer
                    </p>
                    <p className="relative  text-center md:text-left">
                        Front-End: React.js | Vite.js | TypeScript | JavaScript
                    </p>
                    <p className="relative  text-center md:text-left">
                        Back-End: C# | ASP.NET | .NET CORE | SQL | Node.js
                    </p>
